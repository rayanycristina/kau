  ...
  return (
    <div className="space-y-5 pb-10">
      ...
      <section className="grid gap-4 xl:grid-cols-3">
        <TacticalPanel glow="green" className="p-5"><Crown className="text-money" size={24} /><p className="mt-4 text-xs font-black uppercase tracking-[.18em] text-money">Proprietário da operação</p><h2 className="mt-2 text-2xl font-black text-white">{loading ? "Carregando..." : owner?.fullName || "Proprietário não cadastrado"}</h2><p className="mt-2 text-sm leading-6 text-white/58">Vendas próprias do proprietário registram comissão de vendedor em 0%.</p></TacticalPanel>
