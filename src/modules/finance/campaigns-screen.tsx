...
export function CampaignsScreen() {
  ...
  return (
    <div className="space-y-5 pb-10 pt-1">
      ...
      {data.setupRequired ? <CompactNotice text="A migration 031 precisa ser aplicada para ativar vínculos de Campanhas. Os gastos históricos de Tráfego continuam visíveis abaixo." /> : null}
    ...
    <div className="fixed inset-0 z-50 flex justify-end bg-black/70 backdrop-blur-sm">
      ...
      <aside className="relative flex h-full w-full max-w-2xl flex-col border-l border-white/[.08] bg-[#070b12] shadow-[-30px_0_90px_rgba(0,0,0,.55)]">
        ...
        <div className="min-h-0 flex-1 overflow-y-auto p-5">
          {setupRequired ? <CompactNotice text="Aplique a migration 031, após aprovação, para habilitar a coluna campaign_id e realizar atribuições." /> : null}
